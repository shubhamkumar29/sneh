...

{
...

	{
		...
		return '<input id="'.$this->id.'" name="e_mail" class="'.$this->addClass().'"  placeholder="'.$this->field['placeholder'].'" type="text" value="'.$this->user->data->user_email.'" readonly="readonly" />';
...

	{
		...
		//{
			...
			//$data .= '<input name="pie_submit_update" type="submit" class="blueButton" value="'.$this->field['text'].'" />';	
			$data .= '<input name="pie_submit_update" type="submit" class="blueButton" value="Update Profile" />';	
