...
$form_data .= '<div class="piereg_container piereg_fistCol">
...
if ( ('rp' == $_GET['action'] || 'resetpass' == $_GET['action']) && ($newpasspageLock == 0) ){
	...
	$form_data .= '
	  ...
	  <form name="resetpassform" class="piereg_resetpassform" action="'.pie_modify_custom_url(pie_login_url(),'action=resetpass&key=' . urlencode( $_GET['key'] ) . '&login=' . urlencode( $_GET['login'] )).'" method="post" autocomplete="off">
		...
		<div class="field">
		  ...
		  <input type="password" name="pass1" id="pass1" class="input emailInput validate[required]" value="" autocomplete="off">
		...
		<div class="field">
		  ...
		  <input type="password" name="pass2" id="pass2" class="input emailInput validate[required,equals[pass1]]" value="" autocomplete="off">
	...
	<form method="post" action="" class="piereg_loginform" name="loginform">
		<p style="margin-bottom:5px">
			...
			<label for="user_login">Email Address<span style="color:#f00">*</span></label>

			<input placeholder="Email Address" type="text" value="" class="input emailInput validate[required]" id="user_login" name="log" style="margin-top:3px;">
		</p>
		<p style="margin-bottom:5px">

			<label for="user_pass">'.__("Password","piereg").'<span style="color:#f00">*</span></label>



			<input placeholder="Password" type="password" value="" class="input emailInput validate[required]" id="user_pass" name="pwd" style="margin-top:3px;">
		...
		//if(!is_page()) {
			...
			<p class="forgetmenot" style="margin-bottom:0">
		...
		<p class="submit" style="margin-bottom:10px">



			<input type="submit" value="Log In" class="blueButton" id="wp-submit" name="wp-submit" style="margin-top:10px">
