...
get_header(); ?>
	<div id="primary" class="site-content">
    	<div class="headBan">
   	    	<div class="lineHeight0"><img src="<?php echo get_template_directory_uri(); ?>/images/testimonials-page-banner.jpg" alt="Image" /></div>
		</div>
        ...
        <div class="blueWhtBox">
            <div class="width900">
                ...
                <div class="testiBox">
                    ...
                    <div style="width:80px; padding:20px; float:right;"> Savita Bhat, Mumbai </div>
                    <div class="clear"></div>
                </div>
                <div class="testiBox">
                	<div class="testiBoxImg"><img src="<?php echo get_template_directory_uri(); ?>/images/rakesh_mathur.gif" alt="" /></div>
                    ...
                    <div style="width:80px; padding:20px; float:right;"> Rakesh Mathur, <br /> Mumbai </div>
                    <div class="clear"></div>
                </div>
                <div class="testiBox">
                	<div class="testiBoxImg"><img src="<?php echo get_template_directory_uri(); ?>/images/chintan_shah.gif" alt="" /></div>
                    ...
                    <div style="width:80px; padding:20px; float:right;"> Chintan Shah, <br />Mumbai </div>
                    <div class="clear"></div>
                </div>
                <div class="testiBox">
                	<div class="testiBoxImg"><img src="<?php echo get_template_directory_uri(); ?>/images/sunita_soman.gif" alt="" /></div>
                    ...
                    <div style="width:80px; padding:20px; float:right;">  Sunita Soman, <br /> Mumbai </div>
                    <div class="clear"></div>
                </div>
                <div class="testiBox">
                	<div class="testiBoxImg"><img src="<?php echo get_template_directory_uri(); ?>/images/sujata_kapoor.gif" alt="" /></div>
                    ...
                    <div style="width:80px; padding:20px; float:right;"> Sujata Kapoor, <br />Mumbai</div>
                    <div class="clear"></div>
                </div>              
